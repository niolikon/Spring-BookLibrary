...
public class UserControllerIntegrationTest extends DBUnitTest {
    ...
    public void get_ExistentIdGiven_ShouldReturnUser() throws Exception {
...
//        .andExpect(jsonPath("$.author.surname").value(user.getAuthor().getSurname()))
...
//        .andExpect(jsonPath("$.role.name").value(user.getRole().getName()));
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void post_NewUserGiven_ShouldCreateUser() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        Integer snapshot_lastIdx = snapshot.size() - 1;
        User user_first = snapshot.get(0);
        User user_last = snapshot.get(snapshot_lastIdx);
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void post_NewUserWithNoRolesGiven_ShouldReturnError() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        Integer snapshot_lastIdx = snapshot.size() - 1;
        User user_first = snapshot.get(0);
        User user_last = snapshot.get(snapshot_lastIdx);
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void post_ExistentUserGiven_ShouldReturnError() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        User user = snapshot.get(0);
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void delete_ExistentIdGiven_ShouldReturnUser() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        User user = snapshot.get(0);
        Long user_id = user.getId();
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void put_ExistentUserGiven_ShouldModifyUser() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        User user = snapshot.get(0);
        Long user_id = user.getId();
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void put_NonExistentUserGiven_ShouldReturnError() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        User user = snapshot.get(snapshot.size() - 1);
    ...
    @Test
    @DatabaseSetup(value = "/dataset-users.xml", type = DatabaseOperation.CLEAN_INSERT)
    public void put_ExistentUserWithNoRolesGiven_ShouldReturnError() throws Exception {
        List<User> snapshot = this.fetchSnapshot();
        User user = snapshot.get(0);
        Long user_id = user.getId();
        UserRequest userRequest = this.fetchFromEntity(user);
